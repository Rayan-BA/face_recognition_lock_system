...
def train():
    ...
    recognizer = cv.face.LBPHFaceRecognizer.create(radius=1, neighbors=8, grid_x=2, grid_y=2, threshold=70)
...
def recognize():
    ...
    while video_capture.isOpened():
        ...
        for(x,y,w,h) in faces:
            ...
            cv.putText(frame, f"{'real' if pred == 0 else 'spoof'} {str(round(conf))}", (x+5,y-5), cv.FONT_HERSHEY_SIMPLEX, 1, (255,255,255), 2)
